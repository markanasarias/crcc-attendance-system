...
<div class="card shadow mb-8">
    <h3 style="margin-left: 50px; margin-top: 20px;">Pastors</h3>
    <h7 style="margin-left: 50px; margin-bottom: 20px;">Dashboard > Pastors Table </h7>
</div>
</div>
<br>
<!-- Table -->
...
<div class="card shadow mb-4" id="tablecard">
    ...
    <a href="pastoraddlayout.php"><button type="button" class="btn btn-primary">+ Add New</button></a>
    </div>
    <div class="card-body">
