...
<div class="card shadow mb-8">
    ...
    <h7 style="margin-left: 50px; margin-bottom: 20px;">Dashboard > Pastor information </h7>
</div>
</div>
<br>
<div class="col-xl-11 col-lg-12" style="margin-left: 70px;">
...
<div class="card shadow mb-8">
    ...
    <h3 style="margin-left: 50px; margin-top: 20px;">Pastor Information</h3>
        ...
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-7" style="margin-left: 150px;" >
            ...
            <input type="hidden" class="form-control" id="editmember_id" name="editmember_id" value="<?= $student['id']; ?>">
                    ...
                    <input type="submit" name="editpastor_btn" value="Save" class="btn btn-primary" style="margin-left: 950px; margin-top: -65px;"/>
                    </div>
                    <br>
