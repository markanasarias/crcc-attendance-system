...
<form method="POST" action="member/membercode.php" enctype="multipart/form-data" > 
    <br>
    <h3 style="margin-left: 50px; margin-top: 20px;">Member Form</h3>
    <br>
    <br>
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-7" style="margin-left: 150px;" >
            <div class="row g-2">
                    ...
                    <input type="submit" name="sbt-btn" value="Save" class="btn btn-primary" style="margin-left: 950px; margin-top: -65px;"/>
                    </div>
                    <br>
