...
if(isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM logs WHERE date BETWEEN '$minDate' AND '$maxDate'";
...
<div class="col-xl-11 col-lg-12" style="margin-left: 70px;">
        <div class="card shadow mb-8">
            <h3 style="margin-left: 50px; margin-top: 20px;">Attendance Report</h3>
            <h7 style="margin-left: 50px; margin-bottom: 20px;">Dashboard > Attendance Report </h7>
        </div>
    </div>
    <br>
    <!-- Table -->
